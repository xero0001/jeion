...
#Mainallbg	#Mainheader	#headerbox	 #language	dl	dt													{ position:relative; float:left; width:136px; height:29px; }
...
#Mainvisual	.elementbox	 .Maintext	ul	li	strong			{ width:80%; font-size:20px; margin:35px 0 10px 0; display:inline-block; border-bottom:1px solid #eee; padding-bottom:7px; text-shadow: gray 1px 1px 1px;}
#Mainvisual	.elementbox	 .Maintext	ul	li	span				{ font-size:14px; display:inline-block; padding:0 10px; text-shadow: gray 1px 1px 1px;}
...
#MainContents	#Section1	dl	dd	ul	li	dl						{ width:80%; margin:0 auto;}
#MainContents	#Section1	dl	dd	ul	li	dl	dt					{ text-align:left; margin:0; background:none;}
...
#Mainvisual	.elementbox	 .Maintext	ul	li	strong						{ font-size:16px; margin:20px 0 10px 0; padding-bottom:7px; text-shadow: gray 1px 1px 1px;}
#Mainvisual	.elementbox	 .Maintext	ul	li	span							{ font-size:12px; line-height:15px; text-shadow: gray 1px 1px 1px;}

#MainContents																				{ width:100%; margin:150px 0 0 0;}

#MainContents	#Section1	dl	dt	img											{ width:35%; height:auto;}		
#MainContents	#Section1	dl	dd	ul	li	dl	dt	img						{ display:none;}
#MainContents	#Section1	dl	dd	ul	li	dl	dt	span						{ display:block; font-size:16px; line-height:20px;}
#MainContents	#Section1	dl	dd	ul	li	dl	dd							{ font-size:13px;}
#MainContents	#Section1	dl	dd	ul	li	dl	dd	 span				{ display:block; margin-top:17%;}
...
#MainContents	#Section2	dl	dt	img										{ width:46%; height:auto;}		
...
#MainContents	#Section3	dl	dt	img								{ width:25%; height:auto;}
...
#Footer    #Copyright  .copyrights2																{ position:absolute; top:40px; left:0; margin-top:0; font-size:12px; color:#646464;  letter-spacing:0; display:block;}	
...
#Footer    #Copyright  .copybox	.bottommap	.ad2										{ margin-top:0;  font-size:12px; color:#646464;  letter-spacing:0; display:block; font-style:normal; }
...
#MainContents	#Section1	dl	dt	img									{ width:45%; height:auto;}
#MainContents	#Section1	dl	dd	ul	li								{ float:left; width:50%;}
#MainContents	#Section1	dl	dd	ul	li:nth-of-type(1),
#MainContents	#Section1	dl	dd	ul	li:nth-of-type(2)			{ margin-bottom:15px;}
#MainContents	#Section1	dl	dd	ul	li:nth-of-type(3)	dt		{ margin-bottom:10px;}
#MainContents	#Section1	dl	dd	ul	li	p							{ width:80%; margin:0 auto;}
#MainContents	#Section1	dl	dd	ul	li	dl	dt	span				{ font-size:14px; line-height:16px;}
...
#MainContents	#Section2	dl	dt	img									{ width:58%; height:auto;}		
...
#MainContents	#Section3	dl	dt	img									{ width:32%; height:auto;}
