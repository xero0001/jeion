...
import B1400BgBox from "../../../public/images/B1400_bgbox.jpg";
...
div, dl, span							{ margin:0; padding:0; border:0; font-family:"NanumSquare", "Noto Sans","맑은고딕",Malgun Gothic,"나눔고딕",Nanum Gothic,"돋움",dotum,AppleGothic,sans-serif;}
...
input, select, option				{ vertical-align:middle; font-family:"NanumSquare", "Noto Sans","맑은고딕",Malgun Gothic,"나눔고딕",Nanum Gothic,"돋움",dotum,AppleGothic,sans-serif;}
...
#Suballbg	#Mainheader	#menulist #Gnb .info	p									{ position:relative; width:270px; margin:0 auto; padding-top:15px; text-align:left; line-height:16px;  font-size:13px;}
...
.titleroad	.Position	em							{ color:#8baa00; font-size:14px; cursor:default}
...
.tabmenu a									{ display:block; float:left; width:32.8%; height:42px; text-align:center;font-weight:bold; line-height:43px; margin-bottom:3px; border:1px solid #d0d0d0; !important;border-right:none; cursor:pointer; background-color:#f9f9f9; box-sizing:border-box;}
...
.A2000	.nth_left															{ float:left; width:49.5%; height:230px; }
.A2000	.nth_left	dl														{ float:left; width:55%;}
.A2000	.nth_right														{ float:right; width:50%; height:230px; border-left:1px dashed #dfdfdf;}
...
.A4000	.txt_c	dl	dd														{ float:left; width:32%; height:230px; margin:0 2.6% 2.6% 0; border:1px solid #dfdfdf;  font-size:14px; line-height:18px;}
...
.A4000	.txt_c	.none													{ float:right; width:30%; height:230px; border:1px solid #dfdfdf; margin-right:0;}
...
.B1200	.txtbox1	li	dl													{ width:85%; height:190px; padding:5% 5% 0 5%; display:inline-block; background-color:#f9f9f9; border:1px solid #dfdfdf;}
.B1200	.txtbox1	li	dl	dt												{ font-size:18px; color:#5A5046; padding-bottom:4%;}
.B1200	.txtbox1	li	dl	dd												{ color:#707070; font-size:14px; margin-bottom:10px; line-height:20px; background:url(${BtnDott}) left 10px no-repeat; padding-left:12px; border:1px solid red}
.B1200	.txtbox1	.lastli													{ float:right; width:85%; height:190px; padding:5% 5% 0 5%; display:inline-block; background-color:#f9f9f9; border:1px solid #dfdfdf;}
...
.B1300	.txtbox1	li	dl													{ width:85%; height:240px; padding:5% 5% 0 5%; display:inline-block; background-color:#f9f9f9; border:1px solid #dfdfdf;}
.B1300	.txtbox1	li	dl	dt												{ font-size:18px; color:#5A5046; padding-bottom:4%;}
.B1300	.txtbox1	li	dl	dd												{ color:#707070; font-size:14px; margin-bottom:10px; line-height:20px; background:url(${BtnDott}) left 10px no-repeat; padding-left:12px;}
.B1300	.txtbox1	.lastli													{ float:right; width:85%; height:240px; padding:5% 5% 0 5%; display:inline-block; background-color:#f9f9f9; border:1px solid #dfdfdf;}
...
.B1400	.txtbox1	li	dl													{ width:85%; height:200px; padding:5% 5% 0 5%; display:inline-block; background-color:#f9f9f9; border:1px solid #dfdfdf;}
.B1400	.txtbox1	li	dl	dt												{ font-size:18px; color:#5A5046; padding-bottom:4%;}
.B1400	.txtbox1	li	dl	dd												{ color:#707070; font-size:14px; margin-bottom:10px; line-height:20px; background:url(${BtnDott}) left 10px no-repeat; padding-left:12px;}
.B1400	.txtbox1	.lastli													{ float:right; width:85%; height:200px; padding:5% 5% 0 5%; display:inline-block; background-color:#f9f9f9; border:1px solid #dfdfdf;}
...
@media all and (max-width:800px) {
	...
	#open_side .m_topmenu a:first-of-type											{ width:30%; }
	#open_side .m_topmenu a:nth-of-type(2)										{ width:30%;}
	...
	#Footer																										{ height:120px; margin-top:40px !important;}
	...
	.tabmenu a										{ width:32.3%; height:36px; line-height:35px; box-sizing:border-box;}
	...
	.A2000	.bg1																{ background:url(${A2000Img1}) right -5px no-repeat; background-size:25% auto;}
	.A2000	.bg2																{ background:url(${A2000Img2}) right -5px  no-repeat; background-size:25% auto;}
	.A2000	.bg3																{ background:url(${A2000Img3}) right top  no-repeat; background-size:25% auto;}
	.A2000	.bg4																{ background:url(${A2000Img4}) right top  no-repeat; background-size:25% auto;}
	...
	.A4000	.txt_c	dl	dd											{ width:48%; height:230px; margin:0 2% 2% 0;}
	.A4000	.txt_c	dl	dd:nth-of-type(2)						{ float:right; width:48%; height:230px; margin-right:0;}
	.A4000	.txt_c	.none										{ float:right; width:48%; height:230px;}
	...
	.A5000	li	dl	dd	ul	li	strong							{ width:23%;}
	.A5000	li	dl	dd	ul	li	span								{ float:right; width:70%; }
	...
	.B1200	.txtbox2	dl	dd													{ font-size:13px; background:url(${BtnDott}) left 10px no-repeat;}
	...
	.B1300	.txtbox2	dl	dd													{ font-size:13px;  background:url(${BtnDott}) left 10px no-repeat;}
	...
	.B1400	.txtbox2	dl	dd													{ font-size:13px;  background:url(${BtnDott}) left 10px no-repeat;}
...
@media all and (max-width:400px) {
	...
	.A2000	.bg2,															
	.A2000	.bg3,																
	.A2000	.bg4																{ background:none;}

	.A3000	.photo										{ display:none;}
	.A3000	.txtbox										{ width:100%;}
	.A3000	dl	dt	 img									{ width:45%;}
	...
	.A4000	.txt_c	dl	dd:nth-of-type(2)				{ width:100%; height:auto;}
	...
	.B1200	.txtbox2	dl	dd								{line-height:20px;}
	...
	.B1300	.txtbox2	dl	dd								{line-height:20px;}
	...
	.B1400	.txtbox2	dl	dd								{line-height:20px;}
