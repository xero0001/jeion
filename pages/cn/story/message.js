              ...
              <div className="titleroad">
                ...
                <div className="Position">
                  ...
                  <a href="#Start" title="CEO's Message 본문 바로가기">
                    {" "}
                    <em className="highlight">CEO的心声</em>
                  </a>{" "}
                </div>
              </div>
              <hr />
                    ...
                    <dl className="txtbox">
                      ...
                      <dd>
                        <p>
                          <u>
                            {" "}
                            (株)智益安秉承着 "妈妈和宝宝需要的所有的可能性"
                            的理念, 为所有的妈妈们创造最高的价值而努力的公司。{" "}
                          </u>
                        </p>

                        <p>
                          公司创立以后,
                          很多的父母为了健康和幸福的生活开始购买产品。品尝过我们的饼干产品的顾客因为既好吃又健康的特点都非常的感叹。因为尽职尽责的父母才能够给公司带来美好的未来,
                          在此我们致以衷心的感谢。
                        </p>

                        <p>
                          2013年我们开始制作干果产品,
                          通过开发高品质机能性原材料和其他公司产品做出差别化,
                          我们为了以后能成为儿童食品专门企业以上的综合性食品公司一直在努力。{" "}
                        </p>

                        <p>
                          智益安的全体职员, 我们深深地知道,
                          以前的所有成果都是由于顾客的信任和爱换来的。我们的未来是给予人们的健康和幸福的综合性食品公司。所以,
                          我们承诺要通过最好的产品和服务为了孩子和人们做我们能做的事。谢谢。
                        </p>
