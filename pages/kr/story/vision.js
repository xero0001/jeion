                        ...
                        <dd>
                          <ul>
                            <li className="nth_left bg1">
                              <dl>
                                <dt>01. 유아·어린이 안심 먹거리</dt>
                                <dd>
                                  알러지 요소 대체, 첨가물 제어, 공정 관리
                                </dd>
                                <dd>소재화 기술 상용화 R&amp;DB</dd>
                                <dd>디자인 차별화를 통한 국제 경쟁력 확보</dd>
                              </dl>
                            </li>
                            <li className="nth_right bg2">
                              <dl>
                                <dt>02. 지역자원 식품 소재화</dt>
                                <dd>전북도내 9대 클러스터 중점 활용</dd>
                                <dd>
                                  지역자원의 글로벌 소재화를 통한 고부가 창출
                                </dd>
                                <dd>
                                  제품의 고급화 순환 체인 구성(원재료의 수급,
                                  관리)
                                </dd>
                              </dl>
                            </li>
                            <li className="nth_left nth_line bg3">
                              <dl>
                                <dt>03. 국내 유통</dt>
                                <dd>
                                  공항, 면세점 등의 레퍼런스형 고정 유통망 확보
                                </dd>
                                <dd>타겟 특화형 온라인 마케팅 및 B2C</dd>
                                <dd>
                                  SNS, 소셜커머스, 인플루언스 통합형 이커머스
                                </dd>
                              </dl>
                            </li>
                            <li className="nth_right nth_line bg4">
                              <dl>
                                ...
                                <dd>
                                  식품·유아용품 분야 전문박람회 및 프로모션
                                </dd>
                                <dd>UN, 유니세프 등 국제구호단체 연계 수출</dd>
                              </dl>
                            </li>
                          </ul>
                        </dd>
